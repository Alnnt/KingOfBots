      ...
      <div class="col-9">
        <div class="card">
          <div class="card-header">
            ...
            <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#add-bot-form">创建Bot</button>

            <!-- Modal 添加Bot -->
            <div class="modal fade" id="add-bot-form" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  $.ajax({
    ...
    success(resp) {
      if (resp.error_message === "success") {
        ...
        botadd.description = "";
        botadd.content = "";
        Modal.getInstance("#add-bot-form").hide();
        refresh_bots();
      } else {
